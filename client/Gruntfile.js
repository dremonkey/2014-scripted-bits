  ...
  client: {
    ...
    files: {
      ...
      scripts: [
        ...
        // Temporary. To be removed when development is done.
        '<%= paths.client.tld %>/components/angular-masonry/*.js',
        '<%= paths.client.tld %>/components/imagesloaded/imagesloaded.js',
        '<%= paths.client.tld %>/components/skrollr/**/*.js',
      ],
